...
class PlaceOrderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDynamicBundleMixedTrialCart()
    {
        ...
        // Place the order
        $this->markTestSkipped("The cart details have changed. Please refresh the page and try again. Non-updateable subscription details have changed: One time payment amount has changed. $53.30 != $63.30");
